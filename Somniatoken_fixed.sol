...
/*
  SomniaToken
  - ERC20 token with owner-only mint/burn
  - Owner can change name/symbol, set depositRate
  - Users can deposit native currency to receive tokens (minted = msg.value * depositRate)
  - Owner can withdraw native from contract
*/
...
contract SomniaToken is ERC20, Ownable {
    ...
    ) ERC20(initialName, initialSymbol) Ownable(msg.sender) {
    ...
    // override name/symbol to return changeable values
    ...
    // receive/fallback to accept native and mint tokens
